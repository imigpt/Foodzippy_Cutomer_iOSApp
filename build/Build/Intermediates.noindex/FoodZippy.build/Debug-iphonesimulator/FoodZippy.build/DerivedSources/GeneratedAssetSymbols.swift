...
extension ImageResource {
    ...
    static let burger = ImageResource(name: "burger", bundle: resourceBundle)

    /// The "corporate_cashback" asset catalog image resource.
    static let corporateCashback = ImageResource(name: "corporate_cashback", bundle: resourceBundle)

    /// The "favourites" asset catalog image resource.
    static let favourites = ImageResource(name: "favourites", bundle: resourceBundle)

    /// The "redeem_coupon" asset catalog image resource.
    static let redeemCoupon = ImageResource(name: "redeem_coupon", bundle: resourceBundle)

    /// The "student_cashback" asset catalog image resource.
    static let studentCashback = ImageResource(name: "student_cashback", bundle: resourceBundle)
